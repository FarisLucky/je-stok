                                ...
                                <tr>
                                    ...
                                    <td class="qty">
                                        <div class="quantity">
                                            ...
                                            <input type="number" class="qty-text" step="1" min="1" max="99"
                                                name="jumlah" value="<?= $value['jumlah'] ?>">
                                            <span class="qty-plus"
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="hapus_detail"
                                            data-set=<?= $value['id_detail'] ?>>hapus</button>
                                    </td>
                                </tr>
                            </form>
                            <?php } } ?>
