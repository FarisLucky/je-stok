                        ...
                        <form action="" id="form_detail" class="pt-3">
                            ...
                            <div class="margin-top: 5px;">
                                <div class="padding-left: 20px">
                                    <div class="cart">
                                        <button type="" class="btn btn-custom btn-lg addCart" style="font-size: 14px ;"
                                            id="add_cart"><i class="fa fa-shopping-cart"></i> Masukkan
                                            Keranjang</button>
                                        <button type="" class="btn btn-primary btn-lg beli" style="font-size: 14px ;"
                                            id="beli">Beli Sekarang</button>
                                    </div>
                                </div>
            ...
            <div class="col-md-12 mt-5 mb-5">
                <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-harga"
                            role="tab" aria-controls="nav-home" aria-selected="true">Harga Produk</a>
                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-deskripsi"
                            role="tab" aria-controls="nav-profile" aria-selected="false">Deskripsi</a>
                        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-ulasan"
                            role="tab" aria-controls="nav-contact" aria-selected="false">Ulasan</a>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-harga" role="tabpanel"
