...
<div class="container-fluid">
  ...
  <div class="card shadow">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-sm-12">
          <a href="<?= base_url('admin/profil_admin') ?>" class="btn btn-sm btn-secondary float-right"><span class="fa fa-arrow-left"></span> Kembali</a>
        </div>
      </div>
      <hr>
      <!-- !Ttile Form -->
      ...
      <div class="row">
        <div class="col-sm-12">
          <form action="<?= base_url('admin/profil_admin/coreubah') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="file" name="i_foto_admin" class="form-control" value="<?= $profil['foto'] ?>">
