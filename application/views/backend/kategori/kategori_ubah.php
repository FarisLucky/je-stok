...
<div class="container-fluid">
  ...
  <div class="card shadow">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-sm-12">
          <form action="<?= base_url('admin/kategori/coreubah') ?>" method="POST">
            <input type="hidden" name="input_hidden" value="<?= $katgor['id_kategori'] ?>">
            <div class="form-group">
              ...
              <input type="text" name="i_nama_kategori" class="form-control" value="<?= $katgor['nama'] ?>">
