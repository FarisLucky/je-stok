...
<div class="container-fluid">
  ...
  <div class="card shadow">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-sm-12">
          <form action="<?= base_url('admin/sub_menu/coreubah') ?>" method="POST">
            <input type="hidden" name="input_hidden" value="<?= $submen['id_sub_menu'] ?>">
            <div class="form-group">
              ...
              <input type="text" name="i_nama_sub_menu" class="form-control" value="<?= $submen['nama'] ?>">
