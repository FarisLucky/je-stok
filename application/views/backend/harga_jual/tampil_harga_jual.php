               ...
               <?php $no = 1; ?>
                <?php foreach ($harga as $row) { ?>
                  <tr>
                    ...
                    <td><?= $row["harga"] ?></td>
                    <td>
                      <!-- <a href="" data-target="#editModal" class="btn btn-outline-info"><span class="fa fa-edit"></span></a> -->
                      <button class="btn btn-outline-danger mx-2" onclick="deleteData('<?= base_url('admin/Harga_Jual/delete/'. $row['id_harga']) ?>','Hapus')"><span class="fa fa-trash"></span></button>
                    </td>
                  </tr>
                <?php $no++;
                } ?>
