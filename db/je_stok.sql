...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2020 at 04:13 PM
...
(10, 6, 'ba65d909da3858889a101ef1efcb997c.jpg'),
(11, 6, 'ed5b425377e51484009238f5a7d8f909.jpg'),
...
CREATE TABLE `orders` (
  ...
  `id_rekening` int(1) DEFAULT NULL,
...
INSERT INTO `orders` (`id_order`, `id_user`, `tujuan_kirim`, `asal_kiriman`, `total_produk`, `total_harga_produk`, `total_berat`, `satuan_berat`, `kode_kurir`, `biaya_kirim`, `grand_total`, `id_rekening`, `upload_bukti`, `start_bayar`, `exp_bayar`, `status_pesanan`, `pesan_user`, `tgl_pengiriman`, `tgl_sampai`, `no_resi`, `tgl_bayar`, `tgl_input_bayar`, `status_bayar`, `tgl_pesan`) VALUES
(4, '1', 36, 37, 16, 33900, 99, 'gram', '1', 32000, 65900, NULL, NULL, '2019-12-22 15:40:55', '2019-12-22 15:40:55', 1, 'Hai Ini Pesan Dari User', NULL, NULL, '9935872', NULL, NULL, NULL, '2019-12-26 21:02:35'),
(5, '1', 38, 39, 16, 33900, 6300, 'gram', '1', 32000, 65900, NULL, NULL, '2019-12-22 16:02:28', '2019-12-24 16:02:28', 3, 'Hai Ini Pesan Dari User', NULL, NULL, NULL, NULL, NULL, 'terima', '2019-12-26 21:02:35'),
(6, '1', 40, 41, 16, 33900, 6300, 'gram', '1', 32000, 65900, NULL, NULL, '2019-12-26 13:39:22', '2019-12-28 13:39:22', 1, 'Hai Ini Pesan Dari User', NULL, NULL, '9935872', NULL, NULL, NULL, '2019-12-26 21:02:35');
...
(5, 0, 'Krupuk Upil', 99, 'jangan lah kau bersedih , semuanya akan baik-baik saja', 'bungkus', 500, 'gram', 1000, '2019-12-16', '2019-12-15 22:18:25'),
(6, 0, 'potato kentang', 150, 'ariah kakanan lemmak sarah, mun tak partajeh cobak melleh', 'bungkus', 300, 'gram', 1000, '2019-12-09', '2019-12-15 22:20:47'),
(7, 1, 'Rengginang', 120, 'kakanan riah nyaman sarah, ongguen kok', 'bungkus', 600, 'gram', 5000, '2019-12-18', '2019-12-16 13:06:14'),
(8, 3, 'potato kentangsad', 99, 'sdndsnf', 'bungkus', 300, 'gram', 20000, '0000-00-00', '2020-01-02 08:50:10');
...
(1, 'maper96941@imail1.net', 'YhYZHtRnF987lzEOPrqOqKg4ZfNR0Vuq5XeHwt/8O8Y=', 1576084812),
(2, 'maper96941@imail1.net', 'R9zwrQU/N6wGObrLYqb2/QvbF7OdgDwkEd03BgdGShU=', 1576220856);
...
(1, 1, 'cobain', 'iyek', 'tidowom673@jancloud.net', '$2y$10$DZuZf.B54PorIsbBjWLNgujyG6EHsrg7slUsNn18GeRulVvzC9m3u', '082123928334', '', '1', NULL, '2020-01-06 13:23:06');
...
--
ALTER TABLE `alamat`
  MODIFY `id_alamat` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `detail_keranjang`
--
ALTER TABLE `detail_keranjang`
  MODIFY `id_detail` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `foto_produk`
  MODIFY `id_foto` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `harga_jual`
--
ALTER TABLE `harga_jual`
  MODIFY `id_harga` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `keranjang`
  MODIFY `id_keranjang` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `orders`
  MODIFY `id_order` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `produk`
  MODIFY `id_produk` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
