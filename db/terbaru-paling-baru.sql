...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2020 at 05:45 PM
...
(81, 1, 'Rumah Pandean', '082213034131', 'Jl Pakuniran No 28 Jos', '3513130', '67291', '0', 2),
(82, 1, 'Je-Stok', '082213823882', 'Jl.Pakuniran No.30 Jember', '3509730', '68111', '0', 3),
(83, 1, 'Rumah Pandean', '082213034131', 'Jl Pakuniran No 28 Jos', '3513130', '67291', '0', 2),
(84, 1, 'Je-Stok', '082213823882', 'Jl.Pakuniran No.30 Jember', '3509730', '68111', '0', 3),
(85, 1, 'Rumah Pandean', '082213034131', 'Jl Pakuniran No 28 Jos', '3513130', '67291', '0', 2),
(86, 1, 'Je-Stok', '082213823882', 'Jl.Pakuniran No.30 Jember', '3509730', '68111', '0', 3),
(87, 9, 'RUmah Paiton', '082213034131', 'Jl Pakuniran No 60', '3513130', '67291', '0', 1),
(88, 9, 'RUmah Paiton', '082213034131', 'Jl Pakuniran No 60', '3513130', '67291', '0', 2),
(89, 9, 'Je-Stok', '082213823882', 'Jl.Pakuniran No.30 Jember', '3509730', '68111', '0', 3);
...
(14, 28, 5, 20, 7000, 140000),
(15, 28, 5, 21, 7000, 147000);
...
(22, 14, '6b337176a401b3435496b1a406bb275e.jpg');
...
INSERT INTO `kategori` (`id_kategori`, `id_sub_menu`, `nama`) VALUES
(1, 4, 'Hoodie'),
(2, 4, 'Tebal'),
(3, 5, 'Kering'),
(4, 5, 'Basah'),
...
INSERT INTO `menu_grup` (`id_menu`, `nama`, `icn`) VALUES
(9, 'Fashions', 'fashion.svg'),
(10, 'Kuliner', 'kuliner.svg');
...
(28, '9', 88, 89, 25, 200000, 12500, 'gram', '1', 32000, 232000, 'Mandiri - 128 000 4593 338 - Sutomo', NULL, '2020-01-14 09:18:14', '2020-01-16 09:18:14', 1, 'Silahkan', NULL, NULL, NULL, '2020-01-17 09:18:00', '2020-01-14 03:19:00', NULL, '2020-01-14 09:18:14');
...
(5, 1, 'Krupuk Upil', 58, 'jangan lah kau bersedih , semuanya akan baik-baik saja', 'bungkus', 500, 'gram', 1000, '2019-12-16', '2019-12-15 22:18:25'),
(6, 2, 'Coffe Perfect', 150, 'Kopi robusta hasil sangrai berkualitas', 'Pcs', 300, 'gram', 1000, '2019-12-09', '2019-12-15 22:20:47'),
(7, 1, 'Rengginang', 72, 'kakanan riah nyaman sarah, ongguen kok', 'bungkus', 600, 'gram', 5000, '2019-12-18', '2019-12-16 13:06:14'),
...
(14, 2, 'Kopi Lambada', 12, 'Ini Kopi lambada asli jogja', 'Pcs', 23, 'gram', 12000, '2020-01-24', '2020-01-14 08:59:19');
...
INSERT INTO `produk_kategori` (`id`, `id_produk`, `id_kategori`) VALUES
(1, 9, 3),
(2, 5, 3),
(3, 6, 5),
(4, 12, 5);
...
(1, 'menunggu pembayaran', 'masih menunggu informasi pembayaran'),
(2, 'verifikasi pembayaran', 'menunggu verifikasi pembayaran'),
(3, 'order sedang proses', 'pembayaran telah diterima dan produk pesanan, sedang disiapkan untuk dikirim'),
(4, 'dalam pengiriman', 'order sedang dalam pengiriman ke alamat tujuan'),
...
INSERT INTO `sub_menu` (`id_sub_menu`, `id_menu`, `nama`) VALUES
(3, 9, 'Koko'),
(4, 9, 'Jaket'),
(5, 10, 'Makanan'),
(6, 10, 'Minuman');
...
(1, 2, 'cobain', 'iyek', 'pria', 'tidowom673@jancloud.net', '$2y$10$DZuZf.B54PorIsbBjWLNgujyG6EHsrg7slUsNn18GeRulVvzC9m3u', '082123928334', 'd3de7a549ea8fa4362af7e96c09d6d91.jpg', '1', '2020-01-06 13:23:06'),
(2, 3, 'Primadona Jember', 'faris', 'pria', 'sjeselongen@fm46.app', '$2y$10$GpKnLs2VV3kkQFS1fRDwmOlycygf7U8P4LRVTibMX.R9aG67SD29y', '082123928334', '', '1', '2020-01-11 09:59:20'),
(3, 3, 'PT Cilaka Jember', 'roni', 'pria', 'sjeselongen@blademod.icu', '$2y$10$Lt8qk3MfWa9MuWmovR30/.8Pp0XKEw0PEvIbeji23lwX.No50YVOC', '082123928334', '', '1', '2020-01-11 10:12:22'),
...
(7, 1, 'Mamad Alkatiri', 'mamad', 'pria', 'mamaddd@gmail.com', '$2y$10$i1Q95rTFBi7IboN/Gh8UAOyajXyRMoPy8tlw0Poj1EvgpH0GBpJYu', '085812991726', '', '1', '2020-01-12 21:44:30'),
(9, 2, 'fanii', 'fadil', 'pria', 'totiba7230@onmail.top', '$2y$10$ULIH2LkiZv8DfVVL49xFtubwWAtxpRWU5w/3GXQJvZ6lJMRVGmfkq', '081230535882', '', '1', '2020-01-14 08:53:27');
...
--
ALTER TABLE `alamat`
  MODIFY `id_alamat` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT for table `detail_keranjang`
--
ALTER TABLE `detail_keranjang`
  MODIFY `id_detail` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `detail_order`
--
ALTER TABLE `detail_order`
  MODIFY `id_detail` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `foto_produk`
  MODIFY `id_foto` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `harga_jual`
--
ALTER TABLE `harga_jual`
  MODIFY `id_harga` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `keranjang`
  MODIFY `id_keranjang` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `orders`
  MODIFY `id_order` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `sub_menu`
  MODIFY `id_sub_menu` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
